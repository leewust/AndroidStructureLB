 ...
 */
package com.app.liliuhuan.armstest.mvp.ui.adapter;

import android.view.View;

import com.app.liliuhuan.armstest.R;
import com.app.liliuhuan.armstest.bean.User;
import com.app.liliuhuan.armstest.mvp.ui.holder.UserItemHolder;
...
public class UserAdapter extends BaseRecyclerViewAdapter<User> {
    ...
    @Override
    public BaseViewHolder<User> getHolder(View v, int viewType) {
