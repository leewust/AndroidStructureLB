...
import com.app.liliuhuan.mylibrary.http.urlmanager.parser.DefaultUrlParser;
import com.app.liliuhuan.mylibrary.http.urlmanager.parser.UrlParser;
...
public class RetrofitUrlManager {
    ...
    private static final String GLOBAL_DOMAIN_NAME = "Base-Url";
...
//            Timer.v("New Url is { " + newUrl.toString() + " } , Old Url is { " + request.url().toString() + " }");
