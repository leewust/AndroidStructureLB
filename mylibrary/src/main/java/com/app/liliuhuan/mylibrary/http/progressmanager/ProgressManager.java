package com.app.liliuhuan.mylibrary.http.progressmanager;
...
import com.app.liliuhuan.mylibrary.http.progressmanager.body.ProgressInfo;
import com.app.liliuhuan.mylibrary.http.progressmanager.body.ProgressRequestBody;
import com.app.liliuhuan.mylibrary.http.progressmanager.body.ProgressResponseBody;
...
/**
 * ================================================
 * ProgressManager 可监听 App 中所有网络链接的上传以及下载进度,包括 Glide(需要将下载引擎切换为 Okhttp)的图片加载进度,
...
public final class ProgressManager {
    ...
    public static final String IDENTIFICATION_NUMBER = "?Progress=";
    public static final String IDENTIFICATION_HEADER = "Progress";
