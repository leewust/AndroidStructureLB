...
/**
 * @Description: RxJava RxPermissions
 * @Date 2017/12/15 12:50
...
public class RxPermissions {
    ...
    public <T> ObservableTransformer<T, ArrayList<String>> ensureList(final String... permissions) {
        return o -> request(o, permissions)
                .buffer(permissions.length)
                .flatMap((Function<List<Permission>, ObservableSource<ArrayList<String>>>) permissions1 -> {
                    // Return true if all permissions are granted.
    ...
    public Observable<ArrayList<String>> requestEachList(final String... permissions) {
        return Observable.just(TRIGGER).compose(ensureList(permissions));
    }
