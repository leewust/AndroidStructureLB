...
import com.app.liliuhuan.mylibrary.utils.glide.progress.OnGlideImageViewListener;
import com.app.liliuhuan.mylibrary.utils.glide.progress.OnProgressListener;
import com.app.liliuhuan.mylibrary.utils.glide.progress.ProgressManager;
import com.app.liliuhuan.mylibrary.utils.glide.transformation.GlideCircleTransformation;
import com.app.liliuhuan.mylibrary.utils.glide.transformation.GlideRoundTransform;
...
public class GlideImageLoader {
    ...
    public RequestOptions roundRequestOptions(int placeholderResId, int errorResId) {
        return requestOptions(placeholderResId, errorResId)
                .transform(new GlideRoundTransform(CommonUtil.getAppContext()));
    }

    public RequestOptions roundRequestOptions(int placeholderResId, int errorResId,int dip) {
        return requestOptions(placeholderResId, errorResId)
                .transform(new GlideRoundTransform(CommonUtil.getAppContext(),dip));
    }
    public void loadImage(String url, int placeholderResId) {
        load(url, requestOptions(placeholderResId));
    }
    public RequestOptions roundRequestOptions(int placeholderResId) {
        return roundRequestOptions(placeholderResId, placeholderResId);
    }
    public RequestOptions roundRequestOptionsDip(int placeholderResId,int dip) {
        return roundRequestOptions(placeholderResId, placeholderResId,dip);
    }
    ...
    public void loadRoundImage(String url, int placeholderResId) {
        load(url, roundRequestOptions(placeholderResId));
    }

    public void loadRoundImage(String url, int placeholderResId,int dip) {
        load(url, roundRequestOptionsDip(placeholderResId,dip));
    }
