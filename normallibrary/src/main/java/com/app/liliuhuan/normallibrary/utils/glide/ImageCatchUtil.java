...
public class ImageCatchUtil {
    ...
    private final String ImageExternalCatchDir = BaseApp.getApplication().getExternalCacheDir()
    ...
    public void clearImageDiskCache() {
        try {
            if (Looper.myLooper() == Looper.getMainLooper()) {
                ...
                Glide.get(BaseApp.getApplication()).clearDiskCache();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String getCacheSize() {
        try {
            ...
            return getFormatSize(getFolderSize(new File(BaseApp.getApplication().getCacheDir()
                    + File.separator + CustomGlideModule.GLIDE_CARCH_DIR)));
        } catch (Exception e) {
            e.printStackTrace();
        }
